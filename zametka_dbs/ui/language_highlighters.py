...
LIGHT_STYLES = {
    ...
    "keyword2":  _fmt("#8250df"),
    "string":    _fmt("#1a7f37"),
    "comment":   _fmt("#888888", italic=True),
    "number":    _fmt("#b07e00"),
    "function":  _fmt("#b07e00"),
    "type":      _fmt("#633b9a"),
    "builtin":   _fmt("#0891b1"),
    "decorator": _fmt("#633b9a"),
    "operator":  _fmt("#0891b1"),
    "property":  _fmt("#0891b1"),
    "punctuation": _fmt("#888888"),
    "variable":  _fmt("#cf222e"),
    "attribute": _fmt("#0891b1"),
    "constant":  _fmt("#b07e00"),
    "tag":       _fmt("#8250df"),
    "params":    _fmt("#633b9a"),
}
            ...
            if start_idx >= 0:
                ...
                if end_idx >= 0:
                    ...
                    for delim in self._lang.get("strings", []):
                        self._highlight_strings(before, delim)
                        self._highlight_strings(after, delim)
...
PERL = {
    "keywords": [
        ...
        "do", "sub", "my", "our", "local", "state", "return",
        "package", "use", "require", "no", "import", "BEGIN", "END",
        "die", "warn", "last", "next", "redo", "goto",
    ],
    "strings": ['"', "'", "`", "q(", "qq(", "qx(", "qw("],
    "single_comment": "#",
    "block_comment": None,
    "triple_strings": [],
    "builtins": [
        "print", "say", "shift", "unshift", "push", "pop", "splice",
        "split", "join", "map", "grep", "sort", "keys", "values",
        "open", "close", "read", "write", "chomp", "defined", "undef",
        "ref", "bless", "scalar", "wantarray", "caller", "eval",
    ],
    "types": ["scalar", "array", "hash", "CODE", "REF", "GLOB"],
...
R = {
    "keywords": [
        "if", "else", "repeat", "while", "for", "function",
    ...
    "triple_strings": [],
    "builtins": [
        "library", "require", "c", "list", "data.frame", "matrix",
        "factor", "summary", "print", "cat", "paste", "length",
        "nrow", "ncol", "dim", "names", "rownames", "colnames",
        "sapply", "lapply", "apply", "tapply", "mapply",
        "mean", "median", "sd", "var", "cor", "sum", "min", "max",
        "plot", "ggplot", "lm", "glm", "t.test", "chisq.test",
    ],
    "types": ["numeric", "integer", "character", "logical", "complex", "raw"],
    "constants": ["TRUE", "FALSE", "NULL", "NA", "Inf", "NaN", "NA_integer_", "NA_real_", "NA_complex_", "NA_character_"],
    "extra_patterns": [],
}
...
JULIA = {
    "keywords": [
        ...
        "return", "break", "continue", "let", "global", "local",
        "const", "struct", "mutable", "abstract", "primitive",
        "type", "import", "using", "export", "module", "baremodule",
        "try", "catch", "finally", "throw", "macro", "quote",
        "do", "in", "where", "true", "false", "nothing",
    ],
    "strings": ['"', "'"],
    "single_comment": "#",
    "block_comment": ("#=", "=#"),
    "triple_strings": ['"""'],
    "builtins": [
        "println", "print", "push!", "pop!", "pushfirst!", "popfirst!",
        "append!", "length", "size", "eltype", "keys", "values",
        "haskey", "get", "get!", "setindex!", "empty!",
        "map", "filter", "reduce", "sort", "unique",
        "display", "show", "read", "write", "open", "close",
        "parse", "typeof", "convert", "promote", "zero", "one",
    ],
    "types": ["Int", "Int8", "Int16", "Int32", "Int64", "UInt", "UInt8", "UInt16", "UInt32", "UInt64",
              "Float32", "Float64", "Bool", "Char", "String", "Symbol",
              "Vector", "Array", "Matrix", "Tuple", "Dict", "Set", "Pair",
              "AbstractArray", "AbstractString", "Number", "Real", "Integer", "AbstractFloat"],
    "constants": ["true", "false", "nothing", "missing", "Inf", "Inf32", "NaN", "NaN32", "π", "ℯ"],
    "extra_patterns": [
        (r"@\w+", "decorator"),
    ],
}
...
HASKELL = {
    "keywords": [
        ...
        "do", "module", "import", "qualified", "as", "hiding",
        "foreign", "infix", "infixl", "infixr",
    ],
    "strings": ['"', "'"],
    "single_comment": "--",
    "block_comment": ("{-", "-}"),
    ...
    "builtins": [
        ...
        "print", "putStrLn", "read", "show", "fst", "snd",
        "head", "tail", "init", "last", "take", "drop",
        "elem", "notElem", "null", "length", "reverse",
        "concat", "intersperse", "intercalate", "words", "unwords", "lines", "unlines",
    ],
    "types": ["Int", "Integer", "Float", "Double", "Char", "String", "Bool",
              "Maybe", "Either", "IO", "List", "Ordering",
...
DOCKERFILE = {
    "keywords": [
        ...
        "EXPOSE", "ENV", "ARG", "ADD", "COPY", "WORKDIR",
        "USER", "VOLUME", "STOPSIGNAL", "HEALTHCHECK", "SHELL",
        "ONBUILD", ".dockerignore",
    ],
    "strings": ['"', "'"],
    "single_comment": "#",
    "block_comment": None,
    "triple_strings": [],
    "builtins": ["apt-get", "apt", "yum", "dnf", "apk", "pip", "npm"],
    "types": [],
    "constants": [],
    "extra_patterns": [
        (r"\$\{?\w+\}?", "variable"),
...
MAKEFILE = {
    "keywords": [
        ...
        "define", "endef", "include", "-include", "override",
        "export", "unexport", "vpath", ".PHONY", ".SUFFIXES",
        ".DEFAULT", ".PRECIOUS", ".INTERMEDIATE", ".SECONDARY",
        ".SECONDEXPANSION", ".DELETE_ON_ERROR", ".IGNORE",
...
DIFF = {
    ...
    "extra_patterns": [
        ...
        (r"^diff --git .*", "keyword"),
        (r"^index .*", "comment"),
        (r"^new file.*|^deleted file.*|^rename from.*|^rename to.*", "keyword"),
    ],
}
...
LATEX = {
    "keywords": [
        ...
        "renewcommand", "def", "label", "ref", "cite", "bibitem",
        "input", "include", "includeonly", "setcounter", "addtocounter",
        "newcounter", "newtheorem", "newenvironment", "renewenvironment",
        "textbf", "textit", "emph", "underline", "textbf",
        "section", "subsection", "subsubsection", "paragraph",
        "chapter", "part", "tableofcontents", "listoffigures", "listoftables",
    ],
    "strings": [],
    "single_comment": "%",
    "block_comment": None,
    "triple_strings": [],
    "builtins": [
        "item", "hline", "newline", "newpage", "clearpage",
        "hspace", "vspace", "hfill", "vfill", "dotfill",
        "mbox", "fbox", "parbox", "minipage", "raisebox",
        "textwidth", "textheight", "linewidth",
    ],
    "types": ["equation", "align", "gather", "flalign", "multline",
              "itemize", "enumerate", "description",
              "figure", "table", "tabular", "array",
              "abstract", "quote", "quotation", "verbatim", "lstlisting",
...
ZIG = {
    "keywords": [
        "const", "var", "fn", "pub", "return", "if", "else", "for",
        "while", "switch", "defer", "errdefer", "try", "catch",
        "break", "continue", "inline", "comptime", "export",
        "extern", "volatile", "noalias", "align", "linksection",
        "usingnamespace", "test", "struct", "enum", "union",
        "error", "opaque", "packed", "allowzero", "anyframe",
        "async", "await", "resume", "suspend", "nosuspend",
    ],
    "strings": ['"', "'"],
    "single_comment": "//",
    "block_comment": ("/*", "*/"),
    ...
    "builtins": [
        ...
        "@as", "@bitCast", "@boolToInt", "@panic", "@compileLog",
        "@typeOf", "@TypeOf", "@intFromEnum", "@enumFromInt",
        "@intCast", "@floatCast", "@intFromFloat", "@floatFromInt",
        "@ptrToInt", "@intToPtr", "@ptrCast", "@alignCast",
        "@field", "@hasField", "@setField",
        "@sizeOf", "@bitSizeOf", "@alignOf", "@offsetOf",
        "@returnAddress", "@frameAddress", "@errorName", "@errorReturnTrace",
        "@tagName", "@typeName", "@embedFile", "@src",
    ],
    "types": ["u8", "u16", "u32", "u64", "i8", "i16", "i32", "i64", "f16", "f32", "f64", "f128",
              "bool", "void", "anyopaque", "type", "anyerror", "comptime_int", "comptime_float",
              "noreturn", "usize", "isize"],
