...
class MainWindow(QMainWindow):
    ...
    def _load_stylesheet(self, theme: str = "dark") -> str:
        ...
        return f"""
            ...
            QLineEdit#file-search-edit:focus {{
            ...
            QTabWidget#git-tabs::pane {{
                background-color: {bg0};
                border: none;
            }}
            QTabWidget#git-tabs::tab-bar {{
                alignment: center;
            }}
            QTabBar#git-tabs QTabBar::tab {{
                background-color: {bg0};
                color: {fg2};
                font-size: 11px;
                padding: 6px 14px;
            ...
            QTabBar#git-tabs QTabBar::tab:selected {{
                color: {fg0};
                border-bottom: 2px solid #fab283;
            }}
            ...
            QListWidget#git-list::item:selected {{
                background-color: {bg2};
                color: #fab283;
            }}
            QTextEdit#git-diff {{
